...
class DepartmentsTable extends React.Component {
  ...
  render() {
    ...
    return (
      <table>
        <caption>The Departments</caption>
...
class DepartmentsSection extends React.Component {
  ...
  render() {
    ...
    if (this.state.failure) {
      departmentContent = (
        <aside className="lowlight">Failed To Fetch Department Records</aside>
      );
    ...
    return (
      <div>
        <button onClick={this.fetchData}>Fetch Department Data</button>
...
class EmployeesSection extends React.Component {
  ...
  render() {
    ...
    if (this.state.failure) {
      employeeContent = (
        <aside className="lowlight">Failed To Fetch Employee Records</aside>
      );
    ...
    return (
      <div>
        <button onClick={this.fetchData}>Fetch Employee Data</button>
      ...
      <form id="new-employee">
        ...
        <label>
          ...
          <input
            ...
            onChange={this.handleEmpNoChange}
          />
        </label>
...
ReactDOM.render(<DepartmentsSection />, document.getElementById("departments"));

/* Employee Section Content */
ReactDOM.render(<EmployeesSection />, document.getElementById("employees"));
